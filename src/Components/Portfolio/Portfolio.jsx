...
import IMG5 from "../../assets/Real.jpeg";
...
export const Portfolio = () => {
    const soloProjects = [
          ...
          },
          {
            ...
            img: IMG5,
            description:
              "Elegant countryside estate featuring a private pool, landscaped gardens, and panoramic views.....",
            technologies: " React | Express | Node | MongoDB  ",
            link: "https://real-estate-app-mern.netlify.app/",
            github: "https://github.com/Kalaivanisudee/Real_Esate_FE",
          },
          {
            id: 5,
            title: "Todo List App",
